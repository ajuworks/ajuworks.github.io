...
|------|----------------------|-------------|--------------|
| 所在地 | 現在非掲載（掲載しない方針） | — | 掲載が必要になった場合のみ |
| メールアドレス | `ajuworks.official@gmail.com`（事業者情報ページには非掲載。サポート・プライバシーポリシー・利用規約・各アプリページ・フッターに掲載） | tools/generate_app_pages.py の MAIL、手書きHTML | 事業用アドレスに変更する場合 |
...
- 事業者情報ページ（about.html）には所在地・メールアドレスを掲載しない方針です。連絡先はサポートページ等に集約しています。
- 電話番号は現時点では掲載しない方針です。
